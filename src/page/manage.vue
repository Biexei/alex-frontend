		...
		<el-row style="height: 100%; ">
	  		<el-col :span="4" class="left-color" style="min-height: 100%">
				<el-menu :default-active="defaultActive" style="min-height: 100%"  class="left-color" router>
					...
					<el-menu-item v-has="'user'" index="userList" class="left-color"><i class="el-icon-s-custom"></i><span slot="title" class="title-color">用户管理</span></el-menu-item>
					<el-menu-item v-has="'role'" index="role" class="left-color"><i class="el-icon-place"></i><span slot="title" class="title-color">角色管理</span></el-menu-item>
					<el-menu-item v-has="'permission'" index="permission" class="left-color"><i class="el-icon-s-operation"></i><span slot="title" class="title-color">权限管理</span></el-menu-item>
					<el-menu-item v-has="'project'" index="projectList" class="left-color"><i class="el-icon-s-flag"></i><span slot="title" class="title-color">项目管理</span></el-menu-item>
					<el-menu-item v-has="'module'" index="moduleList" class="left-color"><i class="el-icon-potato-strips"></i><span slot="title" class="title-color">模块管理</span></el-menu-item>
					<el-menu-item v-has="'db'" index="dbList" class="left-color"><i class="el-icon-coin"></i><span slot="title" class="title-color">数据源中心</span></el-menu-item>
					<el-menu-item v-has="'factory'" index="dataFactory" class="left-color"><i class="el-icon-tickets"></i><span slot="title" class="title-color">数据工厂</span></el-menu-item>
					...
					<el-submenu v-has="'mock'" index="3"  class="left-color">
						<template slot="title"  class="left-color"><i class="el-icon-odometer"></i><span slot="title" class="title-color">Mocker</span></template>
						...
						<el-menu-item v-has="'mock:api'" index="mockApi"  class="left-color"><i class="el-icon-attract"></i><span slot="title" class="title-color">接口管理</span></el-menu-item>
					</el-submenu>
