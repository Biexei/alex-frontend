  ...
  <div class="fillcontain">
    ...
    <div class="query">
      ...
      >
        ...
        <el-form-item>
          <el-button
            v-has="'interface:case:find'"
            type="primary"
            size="mini"
            @click="selectInterfaceCase(queryForm)"
            >查询</el-button
          >
          <el-button
            v-has="'interface:case:find'"
    ...
    <div class="table_container">
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              <el-form-item label="用例来源">
                <el-input
                  v-if="props.row.source == 0"
                  value="新增"
                  readonly
                  size="mini"
                ></el-input>
                <el-input
                  v-else-if="props.row.source == 1"
                  value="excel"
                  readonly
                  size="mini"
                ></el-input>
                <el-input
                  v-else-if="props.row.source == 2"
                  value="csv"
                  readonly
                  size="mini"
                ></el-input>
                <el-input
                  v-else-if="props.row.source == 3"
                  value="json"
                  readonly
                  size="mini"
                ></el-input>
                <el-input
                  v-else-if="props.row.source == 4"
                  value="yaml"
                  readonly
                  size="mini"
                ></el-input>
        ...
        >
          <template slot-scope="scope">
            <el-row>
              ...
              >
              <el-col :span="21"
                ><span>{{ scope.row.desc }}</span></el-col
              >
            </el-row>
          </template>
        </el-table-column>
      ...
      >
        <el-form :model="dataImport" ref="dataImport">
          ...
          <el-form-item label="并导入" label-width="100px" prop="name">
            <el-select
              v-model="dataImport.suiteId"
              @change="handleSelectSuite"
              size="mini"
            >
              <el-option
                size="mini"
      ...
      <!--自动生成用例-->
      <el-dialog
        @close="closeGeneratorDialog"
        title="生成"
        :visible.sync="generatorDialogFormVisible"
        :close-on-click-modal="false"
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="generatorDialogFormVisible = false" size="mini"
            >取 消</el-button
          >
          <el-button type="primary" @click="handleGenerator" size="mini"
            >确 定</el-button
          >
        </div>
      </el-dialog>
          ...
          <el-collapse>
            ...
            <el-collapse-item title="基本信息">
              ...
              <el-form-item label="*创建人" label-width="100px">
                <el-input
                  v-model="dataAdd.createrRealName"
                  size="mini"
                  disabled
                ></el-input>
              </el-form-item>
            ...
            <el-collapse-item title="请求信息">
              ...
              <el-tabs>
                ...
                <el-tab-pane label="Headers">
                  <el-radio
                    v-model="headerTypeFlag"
                    :label="0"
                    @change="handleChangeHeaderType"
                    >key-value</el-radio
                  >
                  <el-radio
                    v-model="headerTypeFlag"
                  ...
                  <div v-if="headerTypeFlag == 1">
                    <el-input
                      v-model="dataAddHeadersStr"
                      size="mini"
                      type="textarea"
                      :rows="6"
                      placeholder="header json string"
                    ></el-input>
                  </div>
                </el-tab-pane>
                ...
                <el-tab-pane label="Params">
                  <el-radio
                    v-model="paramsTypeFlag"
                    :label="0"
                    @change="handleChangeParamsType"
                    >key-value</el-radio
                  >
                  <el-radio
                    v-model="paramsTypeFlag"
                  ...
                  >
                  <el-button
                    v-if="paramsTypeFlag == 0"
                    @click.prevent="addParams"
                    icon="el-icon-circle-plus-outline"
                    circle
                    type="primary"
                    size="mini"
                  ...
                  <div v-if="paramsTypeFlag == 1">
                    <el-input
                      v-model="dataAddParamsStr"
                      size="mini"
                      type="textarea"
                      :rows="6"
                      placeholder="params json string"
                    ></el-input>
                  </div>
                </el-tab-pane>
                ...
                <el-tab-pane label="Body">
                  <el-radio
                    v-model="bodyTypeFlag"
                    :label="0"
                    @change="handleChangeBodyType"
                    >form-data</el-radio
                  >
                  <el-radio
                    v-model="bodyTypeFlag"
                  ...
                  <div v-if="bodyTypeFlag == 1">
                    <el-input
                      v-model="dataAddFormStr"
                      size="mini"
                      type="textarea"
                      :rows="6"
                      placeholder="form-data json string"
                    ></el-input>
                  </div>
                  <div v-if="bodyTypeFlag == 2">
                    <el-input
                      v-model="dataAddJsonStr"
                      size="mini"
                      type="textarea"
                      :rows="6"
                  ...
                  <div v-if="bodyTypeFlag == 3">
                    <el-input
                      v-model="dataAddFormRaw"
                      size="mini"
                      type="textarea"
                      :rows="6"
                      placeholder="form-data raw"
                    ></el-input>
                  </div>
                </el-tab-pane>
              </el-tabs>
      ...
      <el-dialog
        title="选择"
        :visible.sync="selectProjectModuleDialogFormVisible"
        append-to-body
      >
        <el-form
          :inline="true"
          :model="projectModuleQuery"
          class="demo-form-inline"
          ref="queryForm"
        >
          <el-form-item label="项目编号">
            <el-input
              v-model="projectModuleQuery.projectId"
              placeholder="项目名称"
              size="mini"
            ></el-input>
          </el-form-item>
          <el-form-item label="项目名称">
            <el-input
              v-model="projectModuleQuery.projectName"
              placeholder="项目名称"
              size="mini"
            ></el-input>
          </el-form-item>
          <el-form-item label="模块编号">
            <el-input
              v-model="projectModuleQuery.moduleId"
              placeholder="模块编号"
              size="mini"
            ></el-input>
          </el-form-item>
          <el-form-item label="模块名称">
            <el-input
              v-model="projectModuleQuery.moduleName"
              placeholder="模块名称"
              size="mini"
            ></el-input>
          </el-form-item>
          ...
          <el-tabs value="first">
            <el-tab-pane label="基本信息" name="first">
              ...
              <el-form-item
                label="异常信息"
                label-width="100px"
                v-if="logInfo.status == '错误'"
              >
                <el-input
                  v-model="logInfo.errorMessage"
                  readonly
                  size="mini"
                  type="textarea"
              ...
              <el-form-item label="失败重跑" label-width="100px">
                <template>
                  <el-tag
                    ...
                    disable-transitions
                    >{{ logInfo.isFailedRetryValue }}</el-tag
                  >
                </template>
              </el-form-item>
            </el-tab-pane>
              ...
              <el-row :gutter="25">
                <el-col :span="22">
                  <el-form-item label="headers" label-width="100px">
                    <el-input
                      v-model="logInfo.requestHeaders"
                      readonly
                      size="mini"
                      type="textarea"
                      :autosize="{ minRows: 2, maxRows: 6 }"
              ...
              <el-row :gutter="25" v-if="isShowRawRequestHeaders">
                <el-col :span="22">
                  <el-form-item label="rawHeaders" label-width="100px">
                    <el-input
                      v-model="logInfo.rawRequestHeaders"
                      readonly
                      size="mini"
                      type="textarea"
                      :autosize="{ minRows: 2, maxRows: 6 }"
              ...
              <el-row :gutter="25" v-if="isShowRawRequestParams">
                <el-col :span="22">
                  <el-form-item label="rawParams" label-width="100px">
                    <el-input
                      v-model="logInfo.rawRequestParams"
                      readonly
                      size="mini"
                      type="textarea"
                      :autosize="{ minRows: 2, maxRows: 6 }"
              ...
              <el-row :gutter="25" v-if="isShowRawRequestData">
                <el-col :span="22">
                  <el-form-item label="rawData" label-width="100px">
                    <el-input
                      v-model="logInfo.rawRequestData"
                      readonly
                      size="mini"
                      type="textarea"
                      :autosize="{ minRows: 2, maxRows: 6 }"
              ...
              <el-row :gutter="25" v-if="isShowRawRequestJson">
                <el-col :span="22">
                  <el-form-item label="rawJson" label-width="100px">
                    <el-input
                      v-model="logInfo.rawRequestJson"
                      readonly
                      size="mini"
                      type="textarea"
                      :autosize="{ minRows: 2, maxRows: 6 }"
            ...
            <el-tab-pane label="响应信息" name="third">
              ...
              <el-row :gutter="25">
                <el-col :span="24">
                  <el-form-item label="headers" label-width="100px">
                    <el-input
                      v-model="logInfo.responseHeaders"
                      readonly
                      type="textarea"
                      size="mini"
                      :autosize="{ minRows: 2, maxRows: 6 }"
            ...
            >
              <el-card>
                <el-row>
                  <el-col :span="21">
                    <p>
                      {{ log.executer }} 执行于 {{ log.createdTime }} 耗时
                      {{ log.runTime }}
                    </p>
                  </el-col>
                  <el-col :span="3">
      ...
      <el-dialog
        title="选择前置用例"
        :visible.sync="selectPreCaseDialogFormVisible"
        append-to-body
      >
        <el-form
          :inline="true"
        ...
        >
          <el-form-item label="项目名称">
            <el-input
              v-model="preCaseQuery.projectName"
              placeholder="项目名称"
              size="mini"
            ></el-input>
          </el-form-item>
          <el-form-item label="模块名称">
            <el-input
              v-model="preCaseQuery.moduleName"
              placeholder="项目名称"
              size="mini"
            ></el-input>
          </el-form-item>
      ...
      >
        <el-form :model="dataInfo" ref="dataInfo">
          <el-collapse>
            ...
            <el-collapse-item title="基本信息">
              ...
              <el-form-item label="*创建人" label-width="100px">
                <el-input
                  v-model="dataInfo.createrRealName"
                  size="mini"
                  disabled
                ></el-input>
              </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="copyDialogFormVisible = false" size="mini"
            >取 消</el-button
          >
          <el-button type="primary" @click="handleCopy" size="mini"
            >确 定</el-button
          >
        </div>
      </el-dialog>
  ...
  methods: {
    ...
    async handleAdd() {
      ...
      if (this.paramsTypeFlag == 0) {
        // 对params进行处理 paramsTypeFlag 0:key-value 1:object
      ...
      if (method != 0) {
        //非get请求目前统一考虑成为post请求
        if (this.bodyTypeFlag == 0) {
          // 对body进行处理 0:form-data  1:form-raw 2:json 3：key=value&key=value格式
