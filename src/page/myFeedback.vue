  ...
  <div class="fillcontain">
    ...
    <div class="query">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item>
          <el-button v-has="'feedback:my:find'" type="primary" size="mini" @click="selectFeedbackList(queryForm)">查询</el-button>
          <el-button v-has="'feedback:my:find'" type="primary" size="mini" @click="resetForm">重置</el-button>
          <el-button v-has="'feedback:my:add'" type="primary" size="mini" @click="openAdd" plain>新增</el-button>
        </el-form-item>
      </el-form>
    </div>
...
import {modifyFeedback, findMyFeedback, findMyFeedbackById, removeFeedback, saveFeedback} from "@/api/getData";
export default {
  data() {
    return {
      queryForm: {},
