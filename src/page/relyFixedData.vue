    ...
    <div class="query">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item>
          ...
          <el-button v-has="'data_center:rely_fixed_data:find'" type="primary" size="mini" @click="resetForm">重置</el-button>
          <el-button v-has="'data_center:rely_fixed_data:add'" type="primary" size="mini" @click="openAdd" plain>新增</el-button>
        </el-form-item>
      </el-form>
    </div>
        ...
        <el-table-column fixed="right" label="操作" min-width="10%">
          <template slot-scope="scope">
            <el-button
              ...
              v-has="'data_center:rely_fixed_data:modify'"
              type="primary"
              size="mini"
              icon="el-icon-edit"
              circle
            ...
            <el-button
              ...
              v-has="'data_center:rely_fixed_data:remove'"
              type="danger"
              size="mini"
              icon="el-icon-delete"
              circle
