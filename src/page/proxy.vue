  ...
  <div class="fillcontain">
    ...
    <div class="query">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item>
          <el-button v-has="'setting:proxy:find'" type="primary" size="mini" @click="selectSettingList(queryForm)">查询</el-button>
          <el-button v-has="'setting:proxy:find'" type="primary" size="mini" @click="resetForm">重置</el-button>
          <el-button v-has="'setting:proxy:add'" type="primary" size="mini" @click="openAdd" plain>新增</el-button>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  methods: {
    ...
    async updateSetting() {
      this.dataInfo['value'] = this.dataInfo['host'] + ":" + this.dataInfo['port']
