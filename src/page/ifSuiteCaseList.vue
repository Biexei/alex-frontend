    ...
    <div class="query">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item label="用例名称">
          <el-input v-model="queryForm.caseDesc" placeholder="用例名称" size='mini'></el-input>
        </el-form-item>
        <el-form-item label="URL">
          <el-input v-model="queryForm.url" placeholder="URL" size='mini'></el-input>
        </el-form-item>
        <el-form-item label="用例等级">
          <el-select v-model="queryForm.level" clearable placeholder="请选择"  size='mini'>
            <el-option
      ...
      <el-table :data="dataList" stripe highlight-current-row style="width: 100%">
        <el-table-column property="order" label="排序" min-width="5%">
          <template slot-scope="scope">
            <el-input v-model="scope.row.order" size='mini' @blur='handleEdit(scope.row)'></el-input>
          </template>
        </el-table-column>
