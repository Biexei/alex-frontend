    ...
    <div class="query">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item label="SQL语句">
          <el-input v-model="queryForm.value" placeholder="SQL语句" size='mini'></el-input>
        </el-form-item>                
        <el-form-item>
          <el-button v-has="'data_center:rely_sql_data:find'" type="primary" size="mini" @click="selectRelyDataList(queryForm)">查询</el-button>
          <el-button v-has="'data_center:rely_sql_data:find'" type="primary" size="mini" @click="resetForm">重置</el-button>
          <el-button v-has="'data_center:rely_sql_data:add'" type="primary" size="mini" @click="openAdd" plain>新增</el-button>&nbsp;&nbsp;
          <el-popover
            placement="top-start"
            title="小提示"
            width="300"
