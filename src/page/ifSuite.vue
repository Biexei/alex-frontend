  ...
  <div class="fillcontain">
    ...
    <div class="query">
      ...
      >
        ...
        <el-form-item>
          <el-button
            v-has="'interface:suite:find'"
            type="primary"
            size="mini"
            @click="selectSuiteList(queryForm)"
            >查询</el-button
          >
          <el-button
            v-has="'interface:suite:find'"
      ...
      >
              ...
              <el-form-item>
                <el-tabs>
                  ...
                  <el-tab-pane label="Headers">
                    <el-form-item
                      v-for="(preProcessorHeaders,
                      index) in addPreProcessorHeadersList"
                      :index="index"
                    ...
                    >
                      <el-row :gutter="20">
                        <el-col :span="7">
                          <el-input
                            v-model="preProcessorHeaders.name"
                            placeholder="name"
                            size="mini"
                            @blur="
                              addPreProcessorHeadersItem(preProcessorHeaders)
                            "
                          ></el-input>
                        </el-col>
                        <el-col :span="15">
                          <el-input
                            v-model="preProcessorHeaders.value"
                            placeholder="value"
                            size="mini"
                          ></el-input>
                        </el-col>
                        <el-col :span="2">
                          <el-button
                            @click.prevent="
                              removePreProcessorHeadersItem(preProcessorHeaders)
                            "
                            type="danger"
                            icon="el-icon-delete"
                            circle
                            size="mini"
                            :disabled="addPreProcessorHeadersList.length == 1"
                          ></el-button>
                        </el-col>
                      </el-row>
                    </el-form-item>
                  ...
                  <el-tab-pane label="Params">
                    <el-form-item
                      v-for="(preProcessorParams,
                      index) in addPreProcessorParamsList"
                      :index="index"
                    ...
                    >
                      <el-row :gutter="20">
                        <el-col :span="7">
                          <el-input
                            v-model="preProcessorParams.name"
                            placeholder="name"
                            size="mini"
                            @blur="
                              addPreProcessorParamsItem(preProcessorParams)
                            "
                          ></el-input>
                        </el-col>
                        <el-col :span="15">
                          <el-input
                            v-model="preProcessorParams.value"
                            placeholder="value"
                            size="mini"
                          ></el-input>
                        </el-col>
                        <el-col :span="2">
                          <el-button
                            @click.prevent="
                              removePreProcessorParamsItem(preProcessorParams)
                            "
                            type="danger"
                            icon="el-icon-delete"
                            circle
                            size="mini"
                            :disabled="addPreProcessorParamsList.length == 1"
                          ></el-button>
                        </el-col>
                      </el-row>
                    </el-form-item>
                  ...
                  <el-tab-pane label="Data">
                    <el-form-item
                      v-for="(preProcessorData,
                      index) in addPreProcessorDataList"
                      :index="index"
                    ...
                    >
                      <el-row :gutter="20">
                        <el-col :span="7">
                          <el-input
                            v-model="preProcessorData.name"
                            placeholder="name"
                            size="mini"
                            @blur="addPreProcessorDataItem(preProcessorData)"
                          ></el-input>
                        </el-col>
                        <el-col :span="15">
                          <el-input
                            v-model="preProcessorData.value"
                            placeholder="value"
                            size="mini"
                          ></el-input>
                        </el-col>
                        <el-col :span="2">
                          <el-button
                            @click.prevent="
                              removePreProcessorDataItem(preProcessorData)
                            "
                            type="danger"
                            icon="el-icon-delete"
                            circle
                            size="mini"
                            :disabled="addPreProcessorDataList.length == 1"
                          ></el-button>
                        </el-col>
                      </el-row>
                    </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="editDialogFormVisible = false" size="mini"
            >取 消</el-button
          >
          <el-button type="primary" @click="updateSuite" size="mini"
            >确 定</el-button
          >
        </div>
      </el-dialog>
