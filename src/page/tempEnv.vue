  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      <el-table :data="dataList" stripe highlight-current-row style="width: 100%">
        <el-table-column property="key" label="key" min-width="20%"></el-table-column>
        <el-table-column property="value" label="value" min-width="72%"></el-table-column>
...
import { findAllTempValue, removeTempValue, removeAllTempValue} from "@/api/getData";
export default {
  data() {
    return {
      queryForm: {},
